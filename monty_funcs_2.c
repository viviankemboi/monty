 ...
 *
 * Description: The results are stored in the second value node
...
/**
 * monty_div - Divide the second value from the top of
 *             a stack_t linked list by the top value.
 * @stack: the  pointer to the top mode node of a stack_t linked list.
 * @line_number: The current working line number of a Monty bytecodes file.
 *
 * Description: The results is stored in the second value node
 *              from the top and the top value is removed.
 */
void monty_div(stack_t **stack, unsigned int line_number)
{
...
/**
 * monty_mul - Multiplie the second value from the top of
 *             a stack_t linked list by the top value.
 * @stack: the pointer to the top mode node of a stack_t linked list.
 * @line_number: The current working line number of a Monty bytecodes file.
 *
